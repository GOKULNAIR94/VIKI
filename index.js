module.exports = function( req, res ) {
  ...
  catch(e)
  {
    ...
    if( intentName == 'Budget' || intentName == 'Expense' || intentName.indexOf( "DCP -" ) == 0 || intentName.indexOf( "ADS_" ) == 0 || intentName.indexOf( "Hyperion ADS -" ) == 0 || intentName == 'Hyperion - no - yes' || intentName == 'reporting' || intentName.indexOf( "KIR_" ) == 0  || intentName.indexOf( "EPM_" ) == 0 ){
